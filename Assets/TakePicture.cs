...
public class TakePicture : MonoBehaviour 
{
	...
	private const string BASE_URL = "127.0.0.1/getData.php?url=";
	//enter your google api key for custom search here
	private const string GOOGLE_API_KEY = "AIzaSyDLtAucpCwIuSl16mRMxeJOxqRTjGOtWFs";
	//enter your cloud name from cloudinary here
	private const string CLOUD_NAME = "dst205akq";
	//enter your cloudinary upload preset name
	private const string UPLOAD_PRESET_NAME = "vtulo35f";
